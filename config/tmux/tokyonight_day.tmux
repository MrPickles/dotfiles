...
# Vendored from https://github.com/folke/tokyonight.nvim/blob/main/extras/tmux/tokyonight_day.tmux
...
set -g @prefix_highlight_output_prefix "#[fg=#b15c00]#[bg=#d0d5e3]#[fg=#d0d5e3]#[bg=#b15c00]"
